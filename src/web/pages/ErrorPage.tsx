...
export const ErrorPage: React.FC<ErrorPageProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 text-center select-none relative overflow-y-auto bg-background text-foreground">
